<template>
    ...
    <div class="flex flex-col gap-6" v-if="user.role == 'Педагог'">
        ...
        <FormKit @submit="addLesson" type="form" :actions="false" messages-class="hidden" form-class="flex flex-col gap-4 items-center justify-center">               
            ...
            <FormKit type="text" v-model="lesson.style" validation="required" messages-class="text-[#E9556D] font-Pacifico" name="Стиль танца" outer-class="w-full md:w-2/3 lg:w-1/2" input-class="px-4 py-2 border border-[#673ab7]/70 rounded-xl focus:outline-none w-full" placeholder="Стиль танца"/>
